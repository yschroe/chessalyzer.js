...
describe('Core Features', () => {
    ...
    describe('Basic Parsing', () => {
        ...
        describe('PGN File: One Game, With Comments, Multiple Lines for Moves', () => {
            let data;
            beforeAll(async () => {
                data = await Chessalyzer.analyzePGN('./test/comments_multiline.pgn');
            });
        ...
        describe('PGN File: One Game, With Comments, Single Lines for Moves', () => {
            let data;
            beforeAll(async () => {
                data = await Chessalyzer.analyzePGN('./test/comments_singleline.pgn');
            });
    ...
    describe('Other', () => {
        describe('Singlethreaded Mode', () => {
            let data;
            beforeAll(async () => {
                data = await Chessalyzer.analyzePGN('./test/asorted_games.pgn', undefined, null);
            });
