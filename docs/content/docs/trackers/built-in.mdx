...
console.log(tileAt(tiles.state.tiles, 'f7'));
```

`tileAt` saves you from indexing the 8×8 `tiles` grid by hand. And `f7` turns out to be the most dramatic square in our file — the scholar's mate happened right there:
