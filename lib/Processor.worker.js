...
process.on('message', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
    var TrackerList, proc, _i, _a, a, customTracker, analyzer;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                TrackerList = {};
                proc = new GameProcessor();
                // prepare built-in trackers
                Object.keys(Tracker).forEach(function (key) {
                    TrackerList[Tracker[key].name] = Tracker[key];
                });
                _i = 0, _a = msg.analyzerData.filter(function (val) { return val.path; });
                _b.label = 1;
            case 1:
                if (!(_i < _a.length)) return [3 /*break*/, 4];
                a = _a[_i];
                return [4 /*yield*/, import(a.path)];
            case 2:
                customTracker = _b.sent();
            ...
            case 4:
                analyzer = [];
                msg.analyzerData.forEach(function (a) {
                    var currentAnalyzer = new TrackerList[a.name]();
