...
var GameProcessor = /** @class */ (function (_super) {
    ...
    GameProcessor.checkConfig = function (config) {
        ...
        cfg.filter = cfg.hasFilter ? config.filter : function () { return true; };
...
var Chessalyzer = /** @class */ (function () {
    ...
    Chessalyzer.startBatch = function (path, analyzer, cfg, callback) {
        if (cfg === void 0) { cfg = {}; }
        if (callback === void 0) { callback = { fun: function () { }, rate: 250 }; }
        return __awaiter(this, void 0, void 0, function () {
        ...
        for (var i = 0; i < map.length; i += 1) {
            for (var cnt = 0; cnt < 2; cnt += 1) {
                for (var j = 0; j < map[i].length; j += 1) {
                    var alpha = max === 0 ? 0 : Math.sqrt(map[i][j] / max).toFixed(2);
                    var colorOut = [
