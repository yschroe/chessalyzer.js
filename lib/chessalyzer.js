...
function (_BaseTracker) {
  ...
  _createClass(TileTracker, [{
        ...
        for (var _row = 0; _row < 8; _row += 1) {
          for (var col = 0; col < 8; col += 1) {
            ...
            if (currentPiece.piece !== '') {
              this.tiles[_row][col][currentPiece.color][currentPiece.piece].wasOn += this.cntMoves - currentPiece.movedOn - 1;
            }
    ...
    value: function processMove(from, to, player, piece) {
      if (piece.length > 1) {
        var movedOn = this.tiles[from[0]][from[1]].currentPiece.movedOn;
        this.tiles[from[0]][from[1]][player].wasOn += this.cntMoves - movedOn - 1;
        this.tiles[from[0]][from[1]][player][piece].wasOn += this.cntMoves - movedOn - 1;
