...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ./GameProcessor */ "./src/core/GameProcessor.js"), __webpack_require__(/*! ./GameProcessorMulti */ "./src/core/GameProcessorMulti.js"), __webpack_require__(/*! ../tracker/PieceTracker */ "./src/tracker/PieceTracker.js"), __webpack_require__(/*! ../tracker/TileTracker */ "./src/tracker/TileTracker.js"), __webpack_require__(/*! ../tracker/GameTracker */ "./src/tracker/GameTracker.js"), __webpack_require__(/*! ../tracker/BaseTracker */ "./src/tracker/BaseTracker.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _GameProcessor, _GameProcessorMulti, _PieceTracker, _TileTracker, _GameTracker, _BaseTracker) {
  "use strict";
  ...
  _GameProcessorMulti = _interopRequireDefault(_GameProcessorMulti);
  ...
  class Chessalyzer {
     ...
     * @returns {Promise}
     */
    static startBatch(path, analyzer, cfg = {}, callback = {
      fun: () => {},
      rate: 250
    }) {
      ...
      return new Promise(resolve => {
        ...
        gameProcessor.processPGN(path, cfg, analyzerArray, callback.rate).then(header => {
    ...
    static startMultiCore(path, analyzer, cfg = {}, nCores = -1) {
      ...
      const t0 = performance.now();
      return new Promise(resolve => {
        (0, _GameProcessorMulti.default)(path, cfg, analyzerArray, nCores).then(header => {
          const t1 = performance.now();
          const tdiff = Math.round(t1 - t0) / 1000;
          const mps = Math.round(header.cntMoves / tdiff);
          console.log(`${header.cntGames} games (${header.cntMoves} moves) processed in ${tdiff}s (${mps} moves/s)`);
...
/***/ "./src/core/GameProcessorMulti.js":
/*!****************************************!*\
  !*** ./src/core/GameProcessorMulti.js ***!
  \****************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ./GameProcessor */ "./src/core/GameProcessor.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _GameProcessor) {
  "use strict";
  ...
  const processMulti = (path, cfg, analyzer, nCoresTar) => new Promise(resolve => {
    // Master
    if (cluster.isMaster) {
      ...
      let cntGames = 0;
      let cntMoves = 0;
      const nCores = nCoresTar === -1 || nCoresTar > numCPUs ? numCPUs : nCoresTar;
      analyzer.forEach(a => {
        if (a.type === 'game') {
          cntGameAnalyzer += 1;
      ...
      const config = _GameProcessor.default.checkConfig(cfg); // Parse games first


      _GameProcessor.default.parseGames(path, config, cntGameAnalyzer).then(games => {
        const workers = [];
        const workersFinished = []; // const data = [];
        ...
        const addTrackerData = (gameTracker, moveTracker, nGames, nMoves) => {
        ...
        for (let i = 0; i < nCores; i += 1) {
          ...
          workersFinished.push(false); // console.log(
          // 	`Sending Batch of size ${batchSize} to Child ${i}!`
          // );
          // send batch to worker

          workers[i].send(games.slice(i * batchSize, i * batchSize + batchSize)); // on worker finish

          workers[i].on('message', msg => {
            // console.log(`Child ${i} is done`);
            workersFinished[i] = true;
            addTrackerData(msg.gameAnalyzers, msg.moveAnalyzers, msg.cntGames, msg.cntMoves);
            workers[i].kill(); // if all workers finished, resolve promise
