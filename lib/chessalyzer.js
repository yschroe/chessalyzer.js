...
var _ChessPiece = _interopRequireDefault(__webpack_require__(/*! ./ChessPiece2 */ "./src/ChessPiece2.js"));
...
function () {
  function ChessBoard2() {
    _classCallCheck(this, ChessBoard2);
...
var ChessPiece2 = function ChessPiece2(name, color) {
  _classCallCheck(this, ChessPiece2);

  this.name = name;
  this.color = color;
};

var _default = ChessPiece2;
exports.default = _default;
module.exports = exports["default"];
...
var _ChessBoard = _interopRequireDefault(__webpack_require__(/*! ./ChessBoard2 */ "./src/ChessBoard2.js"));
...
function (_EventEmitter) {
  ...
  _createClass(GameProcessor, [{
    ...
    value: function pawnMove(moveSan) {
      ...
      this.currentMove.from = from; // promotes
    ...
    value: function pieceMove(moveSan) {
      ...
      if (takes) {
        this.currentMove.takes.piece = this.board.tiles[this.currentMove.to[0]][this.currentMove.to[1]];
