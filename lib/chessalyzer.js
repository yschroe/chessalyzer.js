...
var GameProcessor = /** @class */ (function () {
    ...
    GameProcessor.prototype.processPGN = function (path, analyzer, config, batchSize, nThreads) {
        return __awaiter(this, void 0, void 0, function () {
            var cntGames_1, cntMoves_1, readerFinished_1, customPath_1, status_1, cfg_1, forkWorker_1, games_1, game_1, lr_1, nEndForks, i, err_1;
            var _this = this;
    ...
    GameProcessor.prototype.processPGNSingleThreaded = function (path, config, analyzers) {
        return __awaiter(this, void 0, void 0, function () {
            var cfg_2, lr_2, game_2, err_2;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        lr_2.on('line', function (line) {
                            // data tag
                            if (line.startsWith('[') &&
                                (cfg_2.hasFilter || _this.gameAnalyzers.length > 0)) {
                                var key = line.match(/\[(.*?)\s/)[1];
                                var value = line.match(/"(.*?)"/)[1];
                                game_2[key] = value;
                                // moves
...
var Chessalyzer = /** @class */ (function () {
    ...
    Chessalyzer.startBatch = function (path, analyzer, cfg, batchSize, nThreads) {
        if (cfg === void 0) { cfg = {}; }
        if (batchSize === void 0) { batchSize = 8000; }
        if (nThreads === void 0) { nThreads = 1; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        t0 = performance.now();
                        return [4 /*yield*/, gameProcessor.processPGN(path, analyzerArray, cfg, batchSize, nThreads)];
                    case 1:
                        header = _a.sent();
                        t1 = performance.now();
    ...
    Chessalyzer.startBatchSingleThreaded = function (path, analyzer, cfg) {
        if (cfg === void 0) { cfg = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var analyzerArray, gameProcessor, t0, header, t1, tdiff, mps;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        gameProcessor = new GameProcessor();
                        t0 = performance.now();
                        return [4 /*yield*/, gameProcessor.processPGNSingleThreaded(path, cfg, analyzerArray)];
                    case 1:
                        header = _a.sent();
                        t1 = performance.now();
                        tdiff = Math.round(t1 - t0) / 1000;
...
var BaseTracker = /** @class */ (function () {
    ...
    BaseTracker.prototype.add = function (tracker) { };
    return BaseTracker;
}());
