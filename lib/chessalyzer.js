                    ...
                    case 0:
                        ...
                        lr_1.on('line', function (line) {
                            ...
                            if (line.startsWith('[') &&
                                ...
                                if (game_1.moves[game_1.moves.length - 1].match(/\d/) !== null)
                                    game_1.moves.pop();
...
var Chessalyzer = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log("".concat(header.cntGames, " games (").concat(header.cntMoves, " moves) processed in ").concat(tdiff, "s (").concat(mps, " moves/s)"));
                        return [2 /*return*/, header];
                }
            });
        });
    };
    Chessalyzer.generateHeatmap = function (data, square, fun, optData) {
        if (optData === void 0) { optData = {}; }
        var sqrCoords;
        var sqrAlg;
        ...
        for (var i = 0; i < 8; i += 1) {
            ...
            for (var j = 0; j < 8; j += 1) {
                ...
                var loopSqrAlg = GameProcessor.coordsToAlgebraic(loopSqrCoords);
    ...
    Chessalyzer.generateComparisonHeatmap = function (data1, data2, square, fun, optData) {
        if (optData === void 0) { optData = {}; }
        var map = [];
        var max = 0;
        var min = 100000;
