...
var Chessalyzer = /** @class */ (function () {
     ...
     * @returns {Promise}
     */
    Chessalyzer.startBatch = function (path, analyzer, cfg, callback) {
        if (cfg === void 0) { cfg = {}; }
        if (callback === void 0) { callback = { fun: function (gameCnt) { }, rate: 250 }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        t0 = performance.now();
                        return [4 /*yield*/, gameProcessor.processPGN(path, cfg, analyzerArray, callback.rate)];
                    case 1:
                        header = _a.sent();
                        t1 = performance.now();
     ...
     * @returns {Promise}
     */
    Chessalyzer.startBatchMultiCore = function (path, analyzer, cfg, batchSize, nThreads) {
        if (cfg === void 0) { cfg = {}; }
        if (batchSize === void 0) { batchSize = 8000; }
        if (nThreads === void 0) { nThreads = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var analyzerArray, t0, header, t1, tdiff, mps;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        analyzerArray = analyzer;
                        ...
                        t0 = performance.now();
                        return [4 /*yield*/, GameProcessor.processPGNMultiCore(path, cfg, analyzerArray, batchSize, nThreads)];
                    case 1:
                        header = _a.sent();
                        t1 = performance.now();
                        tdiff = Math.round(t1 - t0) / 1000;
