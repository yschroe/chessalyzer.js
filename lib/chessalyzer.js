...
function () {
  ...
  _createClass(Chessalyzer, null, [{
     ...
     * @returns {Promise}
     */
    value: function startBatch(path, analyzers) {
      ...
      return new Promise(function (resolve) {
        ...
        gameProcessor.processPGN(path, cfg, analyzers, callback.rate).then(function () {
    ...
    value: function generateComparisonHeatmap(square, fun, data1, data2, optData) {
      var map = [];
      var max = 0;
...
Chessalyzer.GameTracker = _GameTracker.default;
Chessalyzer.PieceTracker = _PieceTracker.default;
Chessalyzer.TileTracker = _TileTracker.default;
