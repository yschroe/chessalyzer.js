  ...
  _createClass(Chessalyzer, [{
    ...
    value: function startBatch(path) {
      ...
      return new Promise(function (resolve) {
        ...
        _this.gameProcessor.processPGN(path, refreshRate).then(function (board) {
          var dataset = {};
          ...
          console.log("".concat(dataset.data.cntMoves, " moves processed in ").concat(tdiff, "s (").concat(mps, " moves/s)"));
