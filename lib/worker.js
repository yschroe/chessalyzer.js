...
/*!*********************************!*\
  ...
  \*********************************/
/*! namespace exports */
/*! export Chessalyzer [provided] [maybe used in chessalyzer (runtime-defined)] [usage prevents renaming] */
/*! export Tracker [provided] [maybe used in chessalyzer (runtime-defined)] [usage prevents renaming] */
/*! other exports [not provided] [maybe used in chessalyzer (runtime-defined)] */
/*! runtime requirements: __webpack_require__, __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Chessalyzer": () => /* binding */ Chessalyzer,
...
/* harmony import */ var _tracker_PieceTrackerBase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../tracker/PieceTrackerBase */ "./src/tracker/PieceTrackerBase.js");
/* harmony import */ var _tracker_TileTrackerBase__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../tracker/TileTrackerBase */ "./src/tracker/TileTrackerBase.js");
/* harmony import */ var _tracker_GameTrackerBase__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../tracker/GameTrackerBase */ "./src/tracker/GameTrackerBase.js");
/* harmony import */ var _tracker_BaseTracker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../tracker/BaseTracker */ "./src/tracker/BaseTracker.js");
...
class Chessalyzer {
	...
	static async startBatch(
		...
		const gameProcessor = new _GameProcessor__WEBPACK_IMPORTED_MODULE_0__.default();
	...
	static async startBatchMultiCore(
		...
		const header = await _GameProcessor__WEBPACK_IMPORTED_MODULE_0__.default.processPGNMultiCore(
			path,
			cfg,
			analyzerArray,
			batchSize,
	...
	static generateHeatmap(data, square, fun, optData) {
		...
		if (typeof square === 'string') {
			sqrCoords = _GameProcessor__WEBPACK_IMPORTED_MODULE_0__.default.algebraicToCoords(square);
			sqrAlg = square;

			// input type [6,0]
		} else {
			sqrCoords = square;
			sqrAlg = _GameProcessor__WEBPACK_IMPORTED_MODULE_0__.default.coordsToAlgebraic(square);
		}
		...
		for (let i = 0; i < 8; i += 1) {
			...
			for (let j = 0; j < 8; j += 1) {
				...
				const loopSqrAlg = _GameProcessor__WEBPACK_IMPORTED_MODULE_0__.default.coordsToAlgebraic(
					loopSqrCoords
				);
...
const Tracker = {
	Game: _tracker_GameTrackerBase__WEBPACK_IMPORTED_MODULE_3__.default,
	Piece: _tracker_PieceTrackerBase__WEBPACK_IMPORTED_MODULE_1__.default,
	Tile: _tracker_TileTrackerBase__WEBPACK_IMPORTED_MODULE_2__.default,
	Base: _tracker_BaseTracker__WEBPACK_IMPORTED_MODULE_4__.default
};
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _ChessBoard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ChessBoard */ "./src/core/ChessBoard.js");
/* eslint-disable no-inner-declarations */


const { createReadStream } = __webpack_require__(/*! fs */ "fs");
const { createInterface } = __webpack_require__(/*! readline */ "readline");
...
class GameProcessor extends EventEmitter {
	constructor() {
		super();
		this.board = new _ChessBoard__WEBPACK_IMPORTED_MODULE_0__.default();
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _GameProcessor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GameProcessor */ "./src/core/GameProcessor.js");
/* harmony import */ var _Chessalyzer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Chessalyzer */ "./src/core/Chessalyzer.js");
...
process.on('message', (msg) => {
	...
	Object.keys(_Chessalyzer__WEBPACK_IMPORTED_MODULE_1__.Tracker).forEach((key) => {
		TrackerList[_Chessalyzer__WEBPACK_IMPORTED_MODULE_1__.Tracker[key].name] = _Chessalyzer__WEBPACK_IMPORTED_MODULE_1__.Tracker[key];
	});
