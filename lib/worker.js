...
/*! runtime requirements: top-level-this-exports, module, __webpack_exports__, __webpack_require__ */
/*! CommonJS bailout: this is used directly at 13:89-93 */
/*! CommonJS bailout: module.exports is used directly at 648:2-16 */
/***/ (function(module, exports, __webpack_require__) {
  ...
  class GameProcessor extends EventEmitter {
    ...
    findDiag(tarRow, tarCol, mustBeInRow, mustBeInCol, token) {
      ...
      if (validPieces.length > 1) {
        validPieces = validPieces.filter(val => Math.abs(val[0] - tarRow) === Math.abs(val[1] - tarCol) && (mustBeInRow === -1 || val[0] === mustBeInRow) && (mustBeInCol === -1 || val[1] === mustBeInCol));
    ...
    findLine(tarRow, tarCol, mustBeInRow, mustBeInCol, token) {
      ...
      if (validPieces.length > 1) {
        validPieces = validPieces.filter(val => (val[0] === tarRow || val[1] === tarCol) && (mustBeInRow === -1 || val[0] === mustBeInRow) && (mustBeInCol === -1 || val[1] === mustBeInCol));
      } // if no piece could be found, return [-1, -1]
    ...
    findKnight(tarRow, tarCol, mustBeInRow, mustBeInCol, token) {
      ...
      if (validPieces.length > 1) {
        validPieces = validPieces.filter(val => (Math.abs(val[0] - tarRow) === 2 && Math.abs(val[1] - tarCol) === 1 || Math.abs(val[0] - tarRow) === 1 && Math.abs(val[1] - tarCol) === 2) && (mustBeInRow === -1 || val[0] === mustBeInRow) && (mustBeInCol === -1 || val[1] === mustBeInCol));
      } // if no piece could be found, return [-1, -1]
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
...
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_GameProcessor, _Chessalyzer) {
  "use strict";
  ...
  process.on('message', msg => {
    ...
    proc.attachAnalyzers(analyzer); // analyze each game
...
/*! runtime requirements: top-level-this-exports, module, __webpack_exports__, __webpack_require__ */
/*! CommonJS bailout: this is used directly at 13:89-93 */
/*! CommonJS bailout: module.exports is used directly at 51:2-16 */
/***/ (function(module, exports, __webpack_require__) {
