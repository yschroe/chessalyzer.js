...
export default class Chessalyzer {
     ...
     * </ol>
     */
    static generateHeatmap(data: any, square: (string | any[]), fun: Function, optData: any): any;
    /**
     ...
     * </ol>
     */
    static generateComparisonHeatmap(data1: any, data2: any, square: (string | any[]), fun: Function, optData: any): any;
    /**
     ...
     */
    static printHeatmap(map: any[], min: number, max: number): void;
