    ...
    add(tracker: TileTrackerBase) {
        ...
        for (let row = 0; row < 8; row += 1) {
            for (let col = 0; col < 8; col += 1) {
                ...
                this.tiles[row][col].b.capturedOn += tracker.tiles[row][col].b.capturedOn;
                this.tiles[row][col].w.capturedOn += tracker.tiles[row][col].w.capturedOn;

                this.tiles[row][col].b.wasCapturedOn += tracker.tiles[row][col].b.wasCapturedOn;
                this.tiles[row][col].w.wasCapturedOn += tracker.tiles[row][col].w.wasCapturedOn;
